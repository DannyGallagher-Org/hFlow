...
using hFlowRuntime.CustomFlowTypes.Debug;
using hFlowRuntime.Interfaces;
using UnityEditor;
using UnityEditor.SceneManagement;
using UnityEngine;

namespace hFlowEditor
{
    ...
    public class FlowInterstitialEditor : Editor
    {
        ...
        private void DrawAddButton()
        {
            ...
            if (GUILayout.Button("Add")) AddFlowPoint();
        ...
        private void AddFlowPoint()
        {
            ...
            switch (option)
            {
                ...
                case FlowInterstitialObjectTypes.FlowRemoveGameObject:
                    ...
                    break;
                case FlowInterstitialObjectTypes.FlowLoadLevelFromHLevels:
                    newElement = _target.gameObject.AddComponent<FlowLoadLevelFromHLevels>();
                    break;
                default:
                    newElement = _target.gameObject.AddComponent<FlowDebugString>();
